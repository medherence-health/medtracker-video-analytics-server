...
class IncludeAPIRouter(object):
    def __new__(cls):
        ...
        from application.main.routers.video_classifier import router as router_video_classification
        ...
        router.include_router(router_video_classification, prefix='/api/v1', tags=['video_classification'])
        return router
