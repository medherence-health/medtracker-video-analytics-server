...
class AppConfig(BaseModel):
    ...
    # video classification model to use
    ACTION_NET_IMAGE_CLASSIFICATION_MODEL: Path = MODELS_DIR.joinpath(
        'action_net_ex-060_acc-0.745313.h5')
    ACTION_NET_IMAGE_CLASSIFICATION_MODEL_CLASSES: Path = MODELS_DIR.joinpath(
        'model_class.json')
...
class GlobalConfig(BaseSettings):
    ...
    VIDEO_CAPTURE_RATE: Optional[int] = None
